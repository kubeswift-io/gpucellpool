> Design record — validation and post-mortem. Written after
> `provisioner: ClusterAPI` was implemented and validated on hardware
> (2026-08-08). It documents what broke and why, not how to use the feature —
> see `docs/clusterapi-cells.md` for that.
